...
//	 String Password = getCellData(1, 6);
//	 
//	 String ImagePath = getCellData(1, 7);
//	
//	 System.out.println("Executing : Photo Wall Test");
//	
//	 new PhotoWall(driver).photoUpload(EmailId, Password,home+ImagePath, "Responsive Photo Wall Test","This is Bullet, New Classic");
//	
//	 }
//	 
...
//	 String Password = getCellData(1, 6);
//	 
//	 String VideoPath = getCellData(1, 8);
//	
//	 System.out.println("Executing : Video Wall Test");
//	
//	 new VideoWall(driver).videoUpload(EmailId, Password,home+VideoPath, "Responsive Video Wall Test");
//	
//	 }
//	 
...
//	 public void sessionVoteSubmissionTest() throws InterruptedException, InvalidFormatException, IOException {
//	
//	 String EmailId = getCellData(1, 5);
//			
//	 String Password = getCellData(1, 6);
//	
//	 System.out.println("Executing : Session Vote Submission Test");
//	
//	 new Schedule(driver).voteSubmit(EmailId, Password);
//	
//	 }
//	 
//	 @Test(priority = 19,alwaysRun=true)
//	 public void sessionRateSubmissionTest() throws InterruptedException, InvalidFormatException, IOException {
//	
//	 String EmailId = getCellData(1, 5);
//			
//	 String Password = getCellData(1, 6);
//	
//	 System.out.println("Executing : Session Rate Submission Test");
//	
//	 new Schedule(driver).sessionRate(EmailId, Password, "The Session was Awesome");
//	
//	 }
